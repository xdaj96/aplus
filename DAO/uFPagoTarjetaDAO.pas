...
interface
  ...
  type TFPagoTarjetaDAO = class
    ...
    public
      ...
      function obtenerDatosTarjetaPorComprobMed(nro_sucursal:string;nro_comprob:string):TIBQUERY;
...
implementation
 ...
 function TFPagoTarjetaDAO.obtenerDatosTarjetaPorComprobMed(nro_sucursal:string;nro_comprob:string):TIBQUERY;
 begin
     dmfacturador.qfacturador.Database:= dmFacturador.getConexion;
      ...
      begin
        ...
        icomprobante.SQL.Text:= concat('SELECT FIRST 1 pago_tarjeta.IMP_TARJETA,pago_tarjeta.COD_TARJETA FROM OSMAMOVOBRASOCIAL as movos ',
