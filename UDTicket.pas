...
TTasaIVA=class(Tobject)
 ...
 Titemsonline=class(TObject)
  ...
  TTicketItemVAL=class(TObject)
    ...
    cheque: double;
    ctacte: double;
    porcentajeempleados: integer;
    importe_promo: double;
    farmacoins_importe: double;
    afiliadofc: string;
    autofarmaplus: double;
   ...
   //--------- MANEJAR REVERSA DE VALIDADOR-----------//
   tieneReversaValidacion:boolean;


   nroSorteo:string;
   codCategoriaSorteo:string;
...
procedure TTicket.initTotalesIVA;
begin
   TotalesIVA:=TDictionary<string, TTasaIVA>.create;
...
begin
  self.netogravado:=0.00;
  self.netogravadodesc:=0.00;
  self.codigoIVA:='';
