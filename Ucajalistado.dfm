object fcajalistado: Tfcajalistado
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'fcajalistado'
  ClientHeight = 277
  ClientWidth = 407
  Color = clBtnFace
  ...
  object gcajas: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'FEC_OPERACIONES'
        Title.Caption = 'FECHA OPERATIVA'
        Visible = True
      end>
  end
  ...
  object ibcajanombre: TIBQuery
    ...
    object ibcajanombreFEC_OPERACIONES: TDateTimeField
      FieldName = 'FEC_OPERACIONES'
      Origin = '"CJMAAPERTURA"."FEC_OPERACIONES"'
    end
  end
