object Fbuscardatos: TFbuscardatos
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object grillabusqueda: TDBGrid
    Left = 3
    Top = 32
    Width = 585
    Height = 312
    DataSource = dmFacturador.dataafiliados
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -15
    Font.Name = 'Bitstream Vera Sans Mono'
    ...
    TitleFont.Style = []
    OnDblClick = grillabusquedaDblClick
    OnKeyDown = grillabusquedaKeyDown
  end
