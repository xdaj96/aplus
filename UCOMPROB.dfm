object FTIPCOMPROB: TFTIPCOMPROB
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object gtipcomprobante: TDBGrid
    Left = 0
    Top = 3
    Width = 318
    Height = 342
    DataSource = dmFacturador.dstipcomprobantenf
    TabOrder = 0
    ...
    TitleFont.Style = []
    OnDblClick = gtipcomprobanteDblClick
    OnKeyPress = gtipcomprobanteKeyPress
    Columns = <
      item
        Expanded = False
